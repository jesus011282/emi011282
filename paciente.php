...
header img {
  ...
  border: 2px solid #2c3e50;
    ...
    body {
    background-image: url('3.jpg'); /* Cambia 'fondo.jpg' por tu imagen */
    ...
    $(document).ready(function () {
      ...
      $("#fecha_nacimiento").on("blur", function () {
        ...
        if (fecha < minFecha || fecha > maxFecha) {
          $(this).val(""); // Limpiar el campo si está fuera del rango
      ...
      $("#formPaciente").submit(function (e) {
        ...
        if ($("#nombre").val().trim() === "" || $("#telefono").val().trim() === "" || $("#fecha_nacimiento").val().trim() === "") {
          Swal.fire({
            icon: 'error',
            title: 'Error',
