...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $fecha     = $_POST['fecha'] ?? '';     // Usamos el timestamp tal cual
    ...
    // Validar que la hora sea un número (debe ser una hora válida)
    if (!is_numeric($hora) || $hora < 0 || $hora > 23) {
        echo "La hora debe ser un valor numérico entre 0 y 23.";
        exit;
    }

    // Validar que el estado sea uno de los valores posibles (por ejemplo "pendiente", "confirmada", "cancelada")
